...
const App = () => {
  ...
  const ProjectCategory = ({ category, children }: { category: string; children: React.ReactNode }) => (
    <div className="mb-16">
  ...
  const StoryboardItem = ({ date, title, org, desc, icon: Icon, align = 'left', tags = [] }: { date: string; title: string; org: string; desc: string; icon?: React.ElementType; align?: 'left' | 'right'; tags?: string[] }) => (
