...
export function Hero({ search, setFilters }: HeroProps) {
  return (
    <div className="relative pt-8 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden shrink-0 min-h-[500px] flex items-center justify-center text-center md:text-left">
      ...
      <div className="relative z-30 max-w-7xl mx-auto w-full flex flex-col items-center md:items-stretch">
        <div className="flex flex-col md:flex-row justify-between items-center mb-10 md:mb-16 w-full">
          ...
          <div className="hidden md:flex gap-3 mt-4 md:mt-0 flex-wrap justify-center items-center">
        ...
        <div className="max-w-3xl mx-auto md:mx-0 w-full">
          <h2 className="text-4xl md:text-6xl font-light text-white mb-4 md:mb-6 leading-tight font-heading">
            Discover Impact.
          </h2>
          <p className="text-base md:text-lg text-slate-200 mb-8 md:mb-10 max-w-2xl mx-auto md:mx-0 font-manrope font-light leading-relaxed">
          ...
          <div className="relative group max-w-2xl mx-auto md:mx-0 w-full">
            ...
            <input 
              type="text" 
              className="block w-full pl-12 pr-4 py-4 md:py-5 bg-white/10 border border-white/20 rounded-2xl text-white placeholder-slate-400 focus:ring-2 focus:ring-[#c27aff]/50 focus:border-[#c27aff]/50 focus:outline-none transition-all shadow-2xl text-base md:text-lg font-light" 
