      ...
      <div className="space-y-1">
        {OPTIONS.map((option) => {
          ...
          return (
            ...
            >
               {/* Stunning Radio Button (styled like checkbox but round) */}
               <div className={`relative flex items-center justify-center w-5 h-5 rounded-full border transition-all duration-200 ${isSelected ? 'bg-purple-brand border-purple-brand shadow-sm scale-105' : 'bg-white border-slate-300 group-hover:border-purple-400'}`}>
                {isSelected && (
